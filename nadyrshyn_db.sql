...
CREATE TABLE `basket_product` (
  ...
  KEY `baskets_products_products_id_fk` (`product_id`),
  CONSTRAINT `baskets_products_baskets_id_fk` FOREIGN KEY (`basket_id`) REFERENCES `baskets` (`id`),
  CONSTRAINT `baskets_products_products_id_fk` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`)
...
-- Dump completed on 2022-01-17  3:20:44
